...
An Azure Automation template for emailing a CSV report of AVD host pool user
assignments, authenticating via the Automation Account's system-assigned
managed identity. See [`UserAssignmentsReport/README.md`](UserAssignmentsReport/README.md)
for setup, usage, and troubleshooting.
